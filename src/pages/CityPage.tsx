    ...
    <main>
      ...
      <section className="hero hero--service">
        <div className="container">
          ...
          <h1>
            {activeService
              ? `${t(activeService.nameKey)} in ${city}`
              : `Vakman in ${city} — Bouwvast`}
          </h1>
          <p className="lead-xl max-w-2xl">
            {activeService
              ? activeService.intro
              : `Betrouwbare bouw-, renovatie- en onderhoudswerkzaamheden in ${city} en omstreken.`}
          </p>
        </div>
      </section>
          ...
          <div className="space-y-12">
                ...
                {SERVICES.map((s) => {
                  ...
                  return (
                    <button
                      key={s.slug}
                      onClick={() =>
                        navigate({ type: "city", city, serviceSlug: s.slug })
                      }
            ...
            <section className="card p-6 md:p-8">
              <h2 className="text-xl font-bold mb-4">
                Waarom kiezen voor Bouwvast in {city}?
              </h2>
              <div className="space-y-3 text-sm text-[var(--muted)] leading-relaxed">
                <p>
                  Woont u in {city} of heeft u hier een bedrijfspand en zoekt u
                  een betrouwbare vakman voor uw verbouwing, badkamer,
                  schilderwerk of onderhoud? Bouwvast biedt een compleet pakket
                  van vakkundige disciplines onder één dak.
                </p>
                <p>
                  Met één vast aanspreekpunt, duidelijke afspraken en vakmensen
                  met jarenlange ervaring garanderen we dat uw project soepel en
