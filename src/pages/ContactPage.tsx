      ...
      <section className="hero hero--contact">
        <div className="container">
          <div className="breadcrumb mb-4 text-[#86efac]">
            <a href="/" className="text-[#86efac] hover:text-white">
              Home
            </a>
          ...
          <p className="lead-xl max-w-2xl">
            Heeft u plannen, een concrete verbouwing of wilt u eerst even
            overleggen? Wij denken graag met u mee.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-3 mb-16">
            {details.map((d) => (
              ...
              >
                ...
                <p className="text-sm font-semibold text-[var(--fg)] m-0 mb-1">
                  {d.value}
                </p>
          ...
          <div className="grid md:grid-cols-[1.3fr_0.9fr] gap-12 items-start">
            <div className="card p-6 md:p-8 shadow-md">
              ...
              <p className="text-sm text-[var(--muted)] mb-6">
                Vul uw gegevens in en beschrijf uw wensen. We nemen binnen 24
            ...
            <div className="space-y-6">
              <div className="card p-6">
                ...
                <p className="text-sm text-[var(--muted)] leading-relaxed mb-4">
                  Uw all-round bouw- en renovatiebedrijf in de regio Amersfoort,
                  Utrecht en Het Gooi.
                </p>
              ...
              <div className="card p-6 bg-[var(--brand-subtle)] border-[var(--brand-tint)]">
                <h3 className="text-base font-bold text-[var(--brand-dark)] mb-2">
                  Directe bereikbaarheid
                </h3>
                <p className="text-xs text-[var(--muted)] leading-relaxed m-0">
                  Wilt u snel schakelen voor een acute klus of spoedklus? Bel
                  ons direct op <strong>{CONTACT.phoneDisplay}</strong> of stuur
                  een foto via WhatsApp.
                </p>
              </div>
            </div>
          </div>
