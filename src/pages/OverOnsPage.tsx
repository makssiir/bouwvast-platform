    ...
    <main>
      <section className="hero hero--service">
        <div className="container">
          ...
          <p className="lead-xl max-w-2xl">{t("about_page_sub")}</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <div className="space-y-4 text-sm text-[var(--muted)] leading-relaxed mt-4">
                <p>
                  Een verbouwing of renovatie is een ingrijpende gebeurtenis.
                  Bij Bouwvast geloven we dat goed vakmanschap begint bij
                  duidelijke communicatie en betrouwbare planning.
                </p>
                <p>
                  Wij koppelen particulieren en bedrijven aan gecertificeerde
                  vakmensen die hun vak verstaan. Van een enkele badkamer of
                  schilderklus tot een complete casco renovatie.
                </p>
                <p>
                  Onze kernwaarden: afspraak is afspraak, nette en bezemvaste
                  oplevering, en altijd heldere prijzen vooraf.
                </p>
              </div>
            ...
            <div className="founder-card shadow-md">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--muted)] m-0 leading-relaxed">
                  "Wij combineren ambachtelijk vakmanschap met moderne
                  projectbegeleiding. Zo weet u altijd waar u aan toe bent."
                </p>
              </div>
            </div>
          </div>
